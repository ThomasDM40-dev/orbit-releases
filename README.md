...
- **v0.16.x** — Assistant IA local gratuit (Qwen via llama.cpp) · interface repensée (Markdown, Liquid Glass) · **pilotage de l'app par l'IA** (navigation, onglets, réglages — hors-ligne)
